...
type NumberOrDocumentOrDocumentArray<T> =
  | number
  | DocumentType<T>
  | DocumentType<T>[];
...
type PreFnWithAggregate<T> = (
  this: Aggregate<T>,
  next: (error?: Error) => ReturnVoid
) => ReturnVoid;
type PreFnWithDocumentType<T> = (
  this: DocumentType<T>,
...
type PostRegExpResponse<T> = (
  result: NumberOrDocumentOrDocumentArray<T>,
  next: EmptyVoidFn
) => ReturnVoid;
type PostArrayResponse<T> = (
  result: NumberOrDocumentOrDocumentArray<T>,
  next: EmptyVoidFn
) => ReturnVoid;
...
type PostRegExpWithError<T> = (
  error: Error,
  result: NumberOrDocumentOrDocumentArray<T>,
  next: HookNextErrorFn
) => ReturnVoid;
type PostArrayWithError<T> = (
  error: Error,
  result: NumberOrDocumentOrDocumentArray<T>,
  next: EmptyVoidFn
) => ReturnVoid;
...
interface Hooks {
  ...
  post<T>(
    method: RegExp,
    fn: PostRegExpWithError<T>,
    options?: mongoose.SchemaPostOptions
  ): ClassDecorator;

  post<T>(
    method: NumberMethod,
    fn: PostNumberResponse<T>,
    options?: mongoose.SchemaPostOptions
  ): ClassDecorator;

  post<T>(
    method: NumberMethod,
    fn: PostNumberWithError<T>,
    options?: mongoose.SchemaPostOptions
  ): ClassDecorator;

  post<T>(
    method: SingleMethod,
    fn: PostSingleResponse<T>,
    options?: mongoose.SchemaPostOptions
  ): ClassDecorator;

  post<T>(
    method: SingleMethod,
    fn: PostSingleWithError<T>,
    options?: mongoose.SchemaPostOptions
  ): ClassDecorator;

  post<T>(
    method: MultipleMethod,
    fn: PostMultipleResponse<T>,
    options?: mongoose.SchemaPostOptions
  ): ClassDecorator;

  post<T>(
    method: MultipleMethod,
    fn: PostMultipleWithError<T>,
    options?: mongoose.SchemaPostOptions
  ): ClassDecorator;
  ...
  post<T>(
    method: QDM | QDM[],
    fn: PostArrayResponse<T>,
    options?: mongoose.SchemaPostOptions
  ): ClassDecorator;

  post<T>(
    method: QDM | QDM[],
    fn: PostArrayWithError<T>,
    options?: mongoose.SchemaPostOptions
  ): ClassDecorator;
}
